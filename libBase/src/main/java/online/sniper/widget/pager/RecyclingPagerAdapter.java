...
public abstract class RecyclingPagerAdapter extends PagerAdapter {
    ...
    public final Object instantiateItem(ViewGroup container, int position) {
        ...
        view.setTag(R.id.page_adapter_recycler_type, viewType);
    ...
    public final void destroyItem(ViewGroup container, int position, Object object) {
        ...
        int viewType = (int) view.getTag(R.id.page_adapter_recycler_type);
        if (viewType != IGNORE_ITEM_VIEW_TYPE) {
     ...
     *                    we want.
     * @param contentView The old view to reuse, if possible. Note: You should check that this view
     ...
     */
    public abstract View getView(int position, View contentView, ViewGroup container);
}