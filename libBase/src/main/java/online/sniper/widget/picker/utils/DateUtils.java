package online.sniper.widget.picker.utils;
...
/**
 * Created by luozhaocheng on 05/04/2017.
 */
...
public class DateUtils extends android.text.format.DateUtils {
    ...
    private static long[] calculateDifference(long differentMilliSeconds) {
        ...
        LogUtils.d(String.format(Locale.CHINA, "different: %d ms, %d days, %d hours, %d minutes, %d seconds",
