package online.sniper.widget.picker.popup;
...
public abstract class ConfirmPopup<V extends View> extends BasicPopup<View> {
    ...
    protected final View makeContentView() {
        ...
        if (topLineVisible) {
            ...
            int height = DisplayUtils.dip2px(activity, topLineHeight);
    ...
    protected View makeHeaderView() {
        ...
        int height = DisplayUtils.dip2px(activity, topHeight);
        ...
        int padding = DisplayUtils.dip2px(activity, topPadding);
        cancelButton.setPadding(padding, 0, padding, 0);
        if (!TextUtils.isEmpty(cancelText)) {
            cancelButton.setText(cancelText);
        }
        cancelButton.setTextColor(DisplayUtils.toColorStateList(cancelTextColor, pressedTextColor));
        if (cancelTextSize != 0) {
        ...
        if (null == titleView) {
            ...
            int margin = DisplayUtils.dip2px(activity, topPadding);
        ...
        submitButton.setTextColor(DisplayUtils.toColorStateList(submitTextColor, pressedTextColor));
        if (submitTextSize != 0) {
