...
public class CoolRefreshView extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (Math.toDegrees(Math.atan2(distanceY, distanceX)) < 45) {
                    return false;
                }
    ...
    private boolean canChildScrollUp() {
        if (mContentScrollDetector == null) {
            return mPullHandler.getConfig().contentCanScrollUp(this, getContentView());
        } else {
            return mContentScrollDetector.contentCanScrollUp(this);
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DEBUG) {
            Log.d(TAG, "onMeasure: " + MeasureSpec.getSize(heightMeasureSpec) + " maxHeight:" + maxHeight + " mHeaderView：" + mHeaderView.getMeasuredHeight());
        }
    ...
    public void setContentScrollDetector(ContentScrollDetector detector) {
        mContentScrollDetector = detector;
    }
    ...
    private class AllScroller extends ScrollerHelper {
        ...
        void overScrollByCompat(int deltaX, int deltaY,
            ...
            if (DEBUG) {
                Log.d(TAG, " bottom:" + mHeaderView.getBottom() + " mHeaderView.getTop:" + mHeaderView.getTop() + " scrollY:" + getScrollY() + " newScrollY:" + newScrollY + " deltaY:" + deltaY + " finalY:" + mScroller.getFinalY());
            }
        }
    }
    ...
    public interface ContentScrollDetector {
        boolean contentCanScrollUp(CoolRefreshView refreshView);
    }
}
